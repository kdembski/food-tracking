...
describe("Year Preview Component", () => {
  ...
  it("Should get chart path based on provided dates", async () => {
    expect(wrapper.vm.getPath()).toEqual(
      "M 0 40 C 0 37 -4 26 0 25 C 4 24 12 34 20 35 C 28 36 32 29 40 30 C 48 31 52 40 60 40 C 68 40 72 30 80 30 C 88 30 92 38 100 40 C 108 42 112 40 120 40 C 128 40 132 40 140 40 C 148 40 152 40 160 40 C 168 40 172 40 180 40 C 188 40 192 40 200 40 C 208 40 216 40 220 40"
    );
  });
